...
import {UserCreateRequest} from '../../../../core/shared/request/user-create.request';
...
export class UserFormComponent implements OnInit {
  ...
  onSubmit() {
    const requestBody: UserCreateRequest = new UserCreateRequest();
    ...
    requestBody.lastName = this.regService.form.controls['lastName'].value;
    requestBody.dob = this.regService.form.controls['dob'].value;
    requestBody.phoneNo = this.regService.form.controls['phoneNo'].value;
    ...
    this.regService.postNewUserData(requestBody).subscribe((response) => {
      ...
      this.reloadComponent(); // reload user registration page only after user creation successful
    });
  }
